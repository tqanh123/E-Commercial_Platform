...
if(isset($_GET['seller_id'])) {
    ...
    $getUsername = "SELECT a.Username FROM account a JOIN seller s ON s.Account_ID = a.Account_ID WHERE s.Seller_ID = $seller_id";
    ...
    //         echo "<p class='price'>Price: <b>$" . $row['Price'] . "</b></p>";
...
<!-- Third child-->
<div class="bg-light">
    <h3 class="text-center">All <?php echo  $Username ?> Products</h3>
</div>
